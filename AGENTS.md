...
- Segmentation-model schema failures must not abort a completed translation. After bounded retries, fall back deterministically to one target cue per complete sentence group, spanning that group's first start through last end.
